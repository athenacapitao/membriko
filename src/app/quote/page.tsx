      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow flex items-center justify-center py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600">O seu pedido de orçamento foi enviado.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <select required className="w-full px-4 py-3 border rounded-lg">
                ...
                <option value="industrial">Edifícios Industriais</option>
                <option value="comercial">Edifícios Comerciais</option>
                <option value="residencial">Habitações Residenciais</option>
              </select>
            </div>
