...
const projectsMeta = {
  pt: {
    ...
    comingSoon:
      'O nosso portfólio de projetos está em preparação. Em breve partilharemos estudos de caso detalhados das obras de impermeabilização EPDM que realizámos em Portugal.',
  ...
  en: {
    ...
    comingSoon:
      'Our project portfolio is in preparation. We will soon share detailed case studies of EPDM waterproofing works we have completed across Portugal.',
      ...
      <Section bg="elevated">
        <Container>
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <p className="text-lg text-text-muted leading-relaxed mb-4">{text.comingSoon}</p>
