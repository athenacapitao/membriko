        ...
        return (
          <li key={item.step} className="flex gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm z-10">
                {item.step}
              </div>
              {/* Connecting line — hidden on last step */}
              {!isLast && (
                <div className="w-0.5 flex-1 bg-border mt-1 mb-1" aria-hidden="true" />
              )}
            </div>
