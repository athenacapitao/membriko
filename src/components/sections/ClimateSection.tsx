    ...
    >
      <Container>
        <div className="text-center mb-12">
          <h2 id="climate-heading" className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
            {title}
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {points.map((point, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col items-center text-center bg-white/5 border border-white/10 rounded-xl px-4 py-6 sm:px-6 sm:py-8"
              >
